...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 5:
        ...
        print("    outputs/20260612_153045_123456/entropy_scores.json \\")
        print("    outputs/20260612_153045_123456/dga_scores.json \\")
        print("    outputs/20260612_153045_123456/embed_scores.json \\")
        print("    outputs/20260612_153045_123456/scores.json")
        sys.exit(1)
